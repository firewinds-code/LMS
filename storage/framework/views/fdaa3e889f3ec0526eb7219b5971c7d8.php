    ...
    <div class="main-wrapper container">
        ...
        <nav class="navbar navbar-expand-lg main-navbar">
            ...
            <ul class="navbar-nav navbar-right">
                ...
                <li>
                     <a href="<?php echo e(route('cart')); ?>"   class="nav-link nav-link-lg  beep"><i class="fa fa-cart-plus"></i> <?php echo e(getCart()->getTotalItems()); ?></a>
                </li>
                <?php endif; ?>
...
<?php /**PATH D:\wamp64\www\lms\Resources\views/layouts/student.blade.php ENDPATH**/ ?>