...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form id="sessionform" class="form-horizontal" role="form" method="post" action="<?php echo e(adminUrl(array('controller'=>'student','action'=>$action.'session','id'=>$id,'type'=>$type))); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\lms\Resources\views/admin/student/addsession.blade.php ENDPATH**/ ?>