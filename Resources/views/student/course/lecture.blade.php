    ...
    <div class="main-wrapper main-wrapper-1" id="content">
        ...
        <nav class="navbar navbar-expand-lg main-navbar">
            ...
            <ul class="navbar-nav navbar-right">
                <li ><a href="{{ route('student.course-details',['id'=>$course->id,'slug'=>safeUrl($course->name)]) }}"  class="nav-link   nav-link-lg "  ><i class="fas fa-home"></i></a></li>
            </ul>
        </nav>
                    ...
                    @foreach($course->lessons()->orderBy('pivot_sort_order')->get() as $lesson)
                        <li class="dropdown"  >
                            ...
                            <ul class="dropdown-menu">
                                ...
                                @endphp 
                                @if($attendance!= '')
                                <li data-toggle="tooltip" data-placement="right" title="" data-original-title="{{ $classLecture->title }}" >
                                   <a class="nav-link @if($lecture->id == $classLecture->id) selected-item active @endif" href="{{ route(MODULE.'.course.lecture',['lecture'=>$classLecture->id,'course'=>$course->id]) }}"><i class="fa fa-unlock" aria-hidden="true"></i> {{ limitLength($classLecture->title,20) }}</a></li>
                                @else
                                <li data-toggle="tooltip" data-placement="right" title="" data-original-title="{{ $classLecture->title }}" >
                                   <a class="nav-link" href="javaScript::void(0)"> <i class="fa fa-lock" aria-hidden="true"></i>{{ limitLength($classLecture->title,20) }}</a></li>
                                @endif
                                @endforeach
                            </ul>
                        </li>
            ...
            @php  endforeach;  @endphp
                                              ...
                                              <div class="tab-pane fade" id="contact3" role="tabpanel" aria-labelledby="contact-tab3">
                                                  <ul class="nav nav-tabs" role="tablist">
                                                      {{--  <li class="nav-item"><a class="nav-link active"  href="#home1" aria-controls="home1" role="tab" data-toggle="tab">{{  __('Trainer-Chat')  }}</a></li>  --}}
