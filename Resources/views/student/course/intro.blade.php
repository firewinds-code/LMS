        ...
        <div class="profile-widget-description">
            <div>
                ...
                <ul class="nav nav-pills" role="tablist">
                    ...
                    <li  class="nav-item"><a class="nav-link"  href="#profile" aria-controls="profile" role="tab" data-toggle="tab"><i class="fa fa-table"></i> {{  __('Class-Lectures')  }}</a></li>
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane" id="discuss">
                        ...
                        <div>
                            ...
                            <ul class="nav nav-pills" role="tablist">
                                {{--  <li  class="nav-item">
                                    <a  class="nav-link active"  href="#home1" aria-controls="home1" role="tab" data-toggle="tab">
                                    {{  __('Trainer-Chat')  }}</a>
                                </li>  --}}
