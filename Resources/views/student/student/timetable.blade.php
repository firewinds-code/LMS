    ...
    <div class="row">
        <div class="col-md-8">
            <ul class="nav nav-pills" id="myTab3" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="profile-tab3" onclick="classAck('{{ Request::segment(3) }}','{{ Request::segment(4) }}');  return false" data-toggle="tab" href="#profile3" role="tab" aria-controls="profile" aria-selected="false"><i class="fa fa-table"></i> {{  __('Classes')  }}</a>
                </li>
                {{--  <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="test-tab3" onclick="classAck('{{ Request::segment(3) }}','{{ Request::segment(4) }}');  return false"    data-toggle="tab" href="#test3" role="tab" aria-controls="test" aria-selected="false"><i class="fa fa-check"></i> {{  __lang('tests')  }}</a>
                </li>
            </ul>
                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                                @php  foreach($rowset as $row2):  @endphp
                                    <tr>
                                        <td><a data-toggle="modal" data-target="#classModal{{  $row2->id  }}" href="javaScript::voida(0)" style="text-decoration: underline">{{  $row2->name }}</a>
                                             <!-- Modal -->
...
function hideAndShow(value)
{
 ...
 function classAck(id, slug)
 {
    var courseId = id;
    var courseName = slug;
    $.ajax("{{ url('student/class-ack-and-test') }}", {
