                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <p class="help-block text-danger">{{ formElementErrors($form->get('session_name')) }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <p class="help-block text-danger">{{ formElementErrors($form->get('description')) }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <p class="help-block text-danger">{{ formElementErrors($form->get('introduction')) }}</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div >
                                    ...
                                    div class="image"><img data-name="image" src="{{ $display_image }}" alt="" id="thumb" /><br />
                                        {{ formElement($form->get('picture')) }}
                                         <a class="pointer" href="#" onclick="image_upload('image', 'thumb');">{{ __lang('browse') }}</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="javascript:;"  class="pointer" onclick="$('#thumb').attr('src', '{{ $no_image }}'); $('#image').attr('value', '');">{{ __lang('clear') }}</a>  
                                        <input type="file" >
                                    </div> 
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <div id="datepicker1" class="input-group date" > 
                                    <input class="form-control" type="text" id="session_date" name="session_date"  value="@isset($session_date) {{ $session_date }}
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <div id="datepicker2" class="input-group date" > 
                                    <input class="form-control" type="text" id="session_end_date" name="session_end_date" value="@isset($session_end_date) {{ $session_end_date }}
                         ...
                         <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <div >
                                    ...
                                    <p class="help-block text-danger">{{ formElementErrors($form->get('session_status')) }}</p>
                                </div>
                            </div>
                        </div>
...
<script>
        $('#course_wizard').smartWizard({
            ...
            labelFinish:'{{__lang('Submit')}}'  // label for Finish button
        });
