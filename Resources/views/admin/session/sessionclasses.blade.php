        ...
        <table id="selectedTable" class="table table-md table-striped">
            ...
            <tr  id="row-{{ $sessionLesson->id }}" class="sort_row">
                ...
                {{--  <td>
                    ...
                    <input placeholder="{{ __lang('start-time') }}"  style="max-width: 200px" data-id="{{$sessionLesson->id}}" name="lesson_start_{{$sessionLesson->id}}" id="lesson_start_{{$sessionLesson->id}}" class="form-control time lesson_start_time" value="{{$sessionLesson->pivot->lesson_start}}" type="text"/>
                    @php endif;  @endphp
                </td>  --}}
                {{--  <td>
                    @php if($sessionLesson->type=='s'): @endphp
                    <input placeholder="{{ __lang('end-time') }}"  style="max-width: 200px" data-id="{{$sessionLesson->id}}" name="lesson_end_{{$sessionLesson->id}}" id="lesson_end_{{$sessionLesson->id}}" class="form-control time lesson_end_time" value="{{$sessionLesson->pivot->lesson_end}}" type="text"/>
                    @php endif;  @endphp
                </td>  --}}
                {{--  <td>
                    @php if($sessionLesson->type=='s'): @endphp
