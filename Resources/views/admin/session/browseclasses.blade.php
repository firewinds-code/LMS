        ...
        <div class="box_">
            ...
            <div class="box-body_">
                <table class="table table-hover">
                    ...
                    <tbody>
                    @php $type = checkClassOnline($sessionId); foreach($paginator as $row):  @endphp
                           @if($type == $row->type)
                        ...
                        <tr>
                            ...
                            <td class="text-right1">
                               @php $condition = classSelected($sessionId, $row->id)  @endphp
                               @if(!$condition)
                                ...
                                @else
                                <a class="btn btn-primary disabled" href="{{adminUrl(['controller'=>'session','action'=>'setclass','id'=>$row->id])}}?sessionId={{$sessionId}}"><i class="fa fa-check"></i> {{ __('Selected') }}</a>
                                @endif
