            ...
            <div role="tabpanel" class="tab-pane active" id="home">
                ...
                <div class="collapse" id="collapseExample">
                    <div class="well">
                        @php $elements = [
                            ...
                            'certificate_heading','certificate_description','certificate_logo'
                        ];  @endphp
               ...
               <div id="canvas_wrapper" style="overflow: auto">
                   ...
                   <div id="canvas" style=" font-size: 14px; margin:0px auto; position: relative; width: {{ $width }}px; height: {{ $height }}px; overflow: hidden " >
                       ...
                       <div class="canvas_item" id="box_certificate_heading" style=" position: absolute; top: 230px; left: 20px; width: 20px; height: 20px; white-space: nowrap;" >
                        [CERTIFICATE_HEADING]
                    </div>

                    <div class="canvas_item" id="box_certificate_description" style=" position: absolute; top: 260px; left: 20px; width: 20px; height: 20px; white-space: nowrap;" >
                        [CERTIFICATE_DESCRIPTION]
                    </div>

                    <div class="canvas_item" id="box_certificate_logo" style=" position: absolute; top: 290px; left: 20px; width: 20px; height: 20px; white-space: nowrap;" >
                        [CERTIFICATE_LOGO]
                    </div>
