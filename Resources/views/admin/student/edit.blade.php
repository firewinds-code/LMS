...
<div >
    <div class="card">
        <div class="card-header">
             {{ __('Edit-Trainee') }} &nbsp;  <strong>{{ $row->user->name }} {{ $row->user->last_name }}</strong>
        </div>
        <div class="card-body">

              <ul class="nav nav-pills" id="myTab3" role="tablist">
                                    <li class="nav-item">
                                      <a class="nav-link active" id="home-tab3" data-toggle="tab" href="#home3" role="tab" aria-controls="home" aria-selected="true">{{ __('Trainee-Details') }}</a>
                                    </li>
                                    <li class="nav-item">
