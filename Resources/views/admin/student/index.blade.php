			...
			<div >
				<div class="card">
					<div class="card-header">
                        <a class="btn btn-primary float-right" href="{{ adminUrl(array('controller'=>'student','action'=>'add')) }}"><i class="fa fa-plus"></i> {{ __('Add-Trainee') }}</a>
                    </div>
					<div class="card-body">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ __('Trainee-Details') }}</h5>
