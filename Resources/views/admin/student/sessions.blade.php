            ...
            <article class="article article-style-c">
                <div class="article-header">
                    ...
                    {{--  <div class="article-image" data-background="{{ resizeImage($row->picture,671,480,basePath()) }}">  --}}
                        {{--  <div class="article-image" data-background="{{ asset($row->picture) }}" >  --}}
                ...
                <div class="article-details">
                    <div class="article-category"><a href="#">{{ courseType($row->type) }}
                        </a> <div class="bullet"></div> <a href="#" onclick="openModal('{{ __lang('students-for') }} {{ $row->name}}','{{ route('admin.student.sessionenrollees',['id'=>$row->id])  }}')">{{ $studentSessionTable->getTotalForSession($row->id) }} {{ __('Trainee') }}</a></div>
                    ...
                    <div class="article-user">
                        ...
                        <div class="article-user-details">
                            <div class="user-detail-name">
                                <div class="text-job">{{ adminName($row->admin_id) }}</div>
                            </div>
                            <div class="text-job">{{ __('Designation ') }} - ({{ \App\Admin::find($row->admin_id)->user->role->name }})</div>
                        </div>
                    </div>
                        @endif
                            ...
                            <div class="col-md-12">
                                <div class="btn-group dropup hundred-percent">
                                    ...
                                    <div class="dropdown-menu wider-btn">
                                        <a class="dropdown-item has-icon" href="{{ route('admin.student.export',['id'=>$row->id])  }}"><i class="fa fa-users"></i>  {{ __('Export-Trainee') }}</a>
                                        <a class="dropdown-item has-icon" href="{{ route('admin.student.exportbulkattendance',['id'=>$row->id])  }}"   ><i class="fa fa-users"></i> {{ __('Export-Trainee') }} - {{ __lang('attendance-import') }}</a>
                                        @if($row->type != 'c')
