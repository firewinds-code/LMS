            ...
            <div class="card-header">
                ...
                <div class="dropdown d-inline mr-2">
                    ...
                    <ul class="dropdown-menu wide-btn">
                        {{--  onclick="openLargeModal('{{__lang('video-library')}}','{{adminUrl(['controller'=>'lecture','action'=>'library','id'=>$id])}}')"  --}}
                                      ...
                                      <div>
                                          ...
                                          <video width="750" height="300" controls>
                                            @if($video->mime_type == 'video/mp4')
                                                <source src="{{ basePath() }}/uservideo/{{$video->id}}/{{ $video->file_name }}" type="video/mp4">
                                            @endif
                                            @if($video->mime_type == 'video/ogg')
                                                <source src="{{ basePath() }}/uservideo/{{$video->id}}/{{ $video->file_name}}" type="video/ogg">
                                            @endif
                                          </video>
                                          ...
                                          @php $zoomData = @unserialize($row->content); @endphp
