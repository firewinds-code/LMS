            ...
            <div class="card-header_">
                ...
                <form id="filterform"   role="form"  method="get" action="{{ adminUrl(array('controller'=>'lecture','action'=>'library','id'=>$lectureId)) }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <a target="_blank" onclick="$('#generalLargeModal').modal('hide')" class="btn btn-primary float-right" href="{{ adminUrl(array('controller'=>'lecturevideo','action'=>'add')) }}"><i class="fa fa-plus"></i> {{ __lang('add-videos') }}</a>
                    ...
                    @php foreach($paginator as $row):  @endphp
                        <tr>
                            ...
                            {{--  @if(saas())
                                ...
                                {{--  <img class="img-thumbnail" style="max-width: 100px" src="{{ basePath()}}/.$thumb   }}" alt="{{$row->name}}" />  --}}
                            ...
                            <td class="text-right1">
                                    ...
                                    {{--  <a class="btn btn-success"  href="{{adminUrl(['controller'=>'lecturevideo','action'=>'play','id'=>$row->id])}}" target="_blank" ><i class="fa fa-play"></i> {{__lang('play')}}</a>  --}}
