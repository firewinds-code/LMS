...
@section('content')
    ...
    <a class="btn btn-primary" href="{{ adminUrl(array('controller'=>'lecturevideo','action'=>'add')) }}"><i class="fa fa-plus"></i> {{ __lang('add-video') }}</a>
    ...
    <div class="collapse" id="collapseFilter">
        <div class="card card-body">
            <form id="filterform"   role="form"  method="get" action="{{ route('admin.lecturevideo.index')  }}">
                <div class="row">
                    <div class="col-md-3">
                                ...
                                <tr>
                                    ...
                                    <td class="pt-1">
                                        ...
                                        <video width="150" height="100" controls>
                                            ...
                                            @endif
                                            @if($row->mime_type == 'video/ogg')
                                                <source src="{{basePath()}}/{{ $video }}" type="video/ogg">
                                            @endif
                                            @if($row->mime_type == 'video/webm')
                                                <source src="{{basePath()}}/{{ $video }}" type="video/webm">
                                            @endif
                                        </video>
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group dropleft">
                                            ...
                                            <div class="dropdown-menu wide-btn">
                                                ...
                                                {{--  <a class="dropdown-item" href="{{ adminUrl(['controller'=>'lecturevideo','action'=>'play','id'=>$row->id]) }}" target="_blank"><i class="fa fa-play"></i> {{  __lang('Play')  }}</a>  --}}

                                                {{--  <a class="dropdown-item" href="{{ adminUrl(array('controller'=>'video','action'=>'edit','id'=>$row->id)) }}"><i class="fa fa-edit"></i> {{  __lang('Edit')  }}</a>  --}}
                                                <a class="dropdown-item" onclick="return confirm('{{ addslashes(__lang('delete-confirm')) }}')" href="{{ adminUrl(array('controller'=>'lecturevideo','action'=>'delete','id'=>$row->id)) }}"><i class="fa fa-trash"></i> {{  __lang('Delete')  }}</a>
