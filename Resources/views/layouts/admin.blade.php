            ...
            <aside id="sidebar-wrapper">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            @can('access','add_student')<li ><a class="nav-link" href="@route('admin.student.add')">{{ __('Add-Trainee') }}</a></li>@endcan
                                @can('access','view_students')<li ><a class="nav-link" href="@route('admin.student.index')">{{ __('All-Trainee') }}</a></li>@endcan
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                               ...
                               @can('access','edit_site_settings')<li ><a class="nav-link" href="@route('admin.setting.language')">{{ __lang('language') }}</a></li>@endcan
                                    ...
                                    @can('access','view_admins')<li ><a class="nav-link" href="@route('admin.admins.index')">{{ __('Administrators/Trainer') }}</a></li>@endcan
