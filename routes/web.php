...
/*  Route::any('setting/roles','SettingController@roles')->name('setting.roles');
    ...
    Route::any('lecturevideo/play/{id}','VideoController@play')->name('lecturevideo.play');
    Route::any('lecturevideo/delete/{id}','VideoController@delete')->name('lecturevideo.delete');
    

    Route::any('lecturevideo/index','VideoController@index')->name('lecturevideo.index');
    Route::any('lecturevideo/add','VideoController@add')->name('lecturevideo.add');
    ...
    Route::any('delete/{id}', 'AdminsController@destroy');
...
Route::group(['middleware'=>['auth','student'],'prefix' => 'student', 'as' => 'student.','namespace'=>'Student'],function() {
    ...
    Route::get('ackclass', 'StudentController@acknowlwdge')->name('student.ackclass');
    Route::get('class-ack-and-test', 'StudentController@classAckAndTest')->name('student.class-ack-and-test');
