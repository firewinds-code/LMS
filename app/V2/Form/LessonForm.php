...
class LessonForm extends BaseForm {
    public function __construct($name = null,$serviceLocator)
    {
        ...
        // $this->createSelect('type','Class Type',['s'=>__('Training Class'),'c'=>__lang('Online Class')],true,true);

        $this->createSelect('type','Class Type',['c'=>__lang('Online Class')],true,true);
